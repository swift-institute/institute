...
extension Institute.Composition.Test {
    ...
    struct Fixture {
        ...
        // `Institute.Composition.Test`, and [API-ERR-001]'s `@Suite`-member
...
extension Institute.Composition.Test.Fixture {
...
extension Institute.Composition.Test.`Edge Case` {
    @Test
