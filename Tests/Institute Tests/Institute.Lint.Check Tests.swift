...
extension Institute.Lint.Check.Test.`Edge Case` {
    ...
    throws
  {
    ...
    try Institute.Lint.Check.Test.write(
      "", at: path, "Sources/Widget/Widget.docc/Resources/Sample.swift"
    )
    ...
    throws
  {
    ...
    try Institute.Lint.Check.Test.write(
      "", at: path, "Tests/Widget Tests/Support/Nested.swift"
    )
...
extension Institute.Lint.Check.Test {
  ...
  static func write(_ contents: Swift.String, at root: Swift.String, _ relative: Swift.String)
    throws
  {
