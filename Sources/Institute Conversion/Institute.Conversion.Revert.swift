...
extension Institute.Conversion {
    ...
    public struct Revert: Equatable, Sendable, JSON.Serializable {
        ...
        public static func deserialize(_ json: JSON) throws(JSON.Error) -> Self {
            ...
            guard let revertCommit = object["revertCommit"] else {
                throw .missingKey("revertCommit")
            }
            guard let restoredBlob = object["restoredBlob"] else {
                throw .missingKey("restoredBlob")
            }
