...
extension Institute.Source {
    public struct Preparation: Sendable, JSON.Serializable {
        ...
        public let swiftFormatTool: SourceDomain.Profile.Digest
        public let linterExecutable: Swift.String
        public let linterTool: SourceDomain.Profile.Digest
        public let directory: Swift.String
        public let profiles: [Swift.String: SourceDomain.Profile.Digest]
        ...
        public static func deserialize(_ json: JSON) throws(JSON.Error) -> Self {
            ...
            guard Set(object.keys) == expected else {
                throw .typeMismatch(expected: expected.sorted().joined(separator: ","), got: object.keys.sorted().joined(separator: ","))
            }
            ...
            return try .init(
                ...
                swiftFormatTool: SourceDomain.Profile.Digest(json: swiftFormatTool),
                linterExecutable: Swift.String(json: linterExecutable),
                linterTool: SourceDomain.Profile.Digest(json: linterTool),
                directory: Swift.String(json: directory),
                profiles: [Swift.String: SourceDomain.Profile.Digest](json: profiles)
            )
        }
    }
}
