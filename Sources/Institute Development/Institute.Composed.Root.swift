...
extension Institute.Composed.Root {
  ...
  static func contributing(_ manifests: [Institute.Composed.Manifest]) -> [Institute.Composed
    .Manifest]
  {
  ...
  public static func render(_ manifests: [Institute.Composed.Manifest], swift: Swift.String)
    -> Swift.String
  {
